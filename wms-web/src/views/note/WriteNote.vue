<template>
  <div class="xjt-write-travelnote-view">
    <div class="my-title-text-clip">写文章</div>
    ...
    <div class="form-wrapper">
      <el-form ref="editForm"
        ...
        <el-form-item label="发布者头像">
          <image-preview :src="'/profile/upload/2024/01/08/icon1_20240108163339A002.png'" :width="50" :height="50"/>
        </el-form-item>
    ...
    data(){
      return{
        editForm: {
          ...
          coverImage: null,
          location:"",
          type: true,			//类型,true-热门  false-最新发布
          publiser_name:"",
          publiser_avatar:"",
