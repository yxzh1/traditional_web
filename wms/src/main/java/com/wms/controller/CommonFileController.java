...
import com.wms.common.utils.FileUploadUtils;
...
public class CommonFileController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try
        {
            ...
            String filePath = TradConfig.getDownloadPath() + fileName;
    ...
    public Result uploadFile(MultipartFile file) throws Exception {
        ...
        {
            // 上传文件路径
            String filePath = TradConfig.getUploadPath();
            // 上传并返回新文件名称
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = TradConfig.getProfile();
            // 数据库资源地址
